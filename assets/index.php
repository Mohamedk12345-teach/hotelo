...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@HORNAFRICA.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+254 746 511 499</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HORN <span>AFRICA</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="../registration/register.php" >Book Now</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>HORN <span>AFRICA</span></h4>
										<img src="images/jik.jpg" alt=" " class="img-responsive">
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="../registration/register.php"><h2>ROOM RESERVATION</h2></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HORN AFRICA</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">ABOUT OUR HORN AFRICA</h3> 
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<img src="images/lion.jpg" class="img-responsive" alt="Hair Salon">
										</div>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Bonny Tum</h4>
							<span>Manager</span>
							<p>Bonny Tum is one of the founding members of Horn Africa Hotel, bringing an innovative approach to the Hotel Management industry. He has been involved in the tourism sector since the 90’s and became one of the most influential executives at Horn Travel before setting up the new Horn Africa Hotel group in 2005.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Before joining  Horn Africa Hotel, first as Reservation Agent and now Receptionist, Nasra had notched up a vast amount of experience in the hotel and hospitality sector.Skilled in guest relations, customer service and management software systems, Nasra’s all-round knowledge makes her a valuable asset to the company. </p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>$</span>320</h3>						
								<a href="../registration/register.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+254 746 511 499</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@HORNAFRICA.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New Kalmunai Road, Masai Mara, Nairobi</p>
...
<!--footer---->
			<div class="copy">
		        <p>© 2020 HORNAFRICA . All Rights Reserved | Design by <a href="index.php">HORNAFRICA</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
